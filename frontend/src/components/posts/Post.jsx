        ...
        <div className="flex justify-between p-1">
          ...
          {(comment.author._id === userID || userID === post.author._id) && ( //Check if comment author is current user or if current user created the post
            <FaTrash
              ...
              className="cursor-pointer transition duration-75 ease-linear hover:fill-red-600"
            />
          )}
        </div>
      </div>
        ...
        <div className="flex items-center gap-2 p-1">
          ...
          {post.author._id === userID && (
            <FaTrash
              ...
              className="ml-auto cursor-pointer transition duration-75 ease-linear hover:fill-red-600"
            />
          )}
        </div>
        ...
        <div className="flex gap-1 px-1">
          ...
          >
            ...
            {post.likes.find((id) => id === userID) ? (
              ...
              <FaHeart className="fill-slate-700 transition duration-100 ease-linear hover:fill-red-300" />
            )}
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="flex items-center gap-4 border-t p-1">
              ...
              <IoMdSend
                ...
                className="fill-slate-700 text-white w-10 h-10 cursor-pointer transition duration-75 ease-linear hover:fill-odin-gold"
              />
            </div>
          </div>
        )}
