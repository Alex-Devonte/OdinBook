      ...
      <div className=" ">
        ...
        <div className="flex flex-col items-center mt-10">
          <img
            ...
            className="w-44 md:w-64 md:h-64 h-44 object-cover object-top rounded-full mb-5"
          />
          <div className="flex flex-col">
            <input
              ...
              className="bg-slate-700 text-white p-1 rounded-md mb-5 shadow-md"
            />
            <button
              onClick={handleUpload}
              className="bg-slate-700 text-white p-2 rounded-md mb-5 shadow-md transition duration-100 ease-linear hover:bg-odin-gold active:bg-odin-gold"
            >
        ...
        <div className="p-5 md:flex flex-col  md:w-1/4 md:mx-auto">
          ...
          <div className="flex flex-col">
            <textarea
              ...
              value={bio}
              className="border-2 border-slate-600 my-6 p-1 read-only:bg-slate-400 read-only:text-white"
            ></textarea>
            {editMode ? (
              <div className="flex justify-between">
                <button
                  onClick={handleSubmit}
                  className="self-start bg-slate-700 text-white p-2 rounded-md mb-5 shadow-md transition duration-100 ease-linear hover:bg-odin-gold active:bg-odin-gold"
                >
                  Update Bio
                </button>
                <button
          ...
          <div className="flex flex-col p-5 md:w-1/4 md:mx-auto">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <input
                ...
                readOnly
                value={user.email}
                className="bg-slate-400 border-2 border-slate-600 p-1"
              />
            </div>
